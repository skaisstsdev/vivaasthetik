    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 max-w-5xl mx-auto">
        {services.map((service, idx) => (
          <div 
            key={service.slug} 
            className="relative group overflow-hidden rounded-sm aspect-square bg-gray-900 flex flex-col"
          >
            {/* Image Background */}
            {service.imageSrc && (
            ...
            <div className="relative z-10 flex flex-col h-full p-5 md:p-8 text-white">
              ...
              <div className="absolute left-5 md:left-8 right-5 md:right-8 bottom-5 md:bottom-8 transition-all duration-500 opacity-100 group-hover:opacity-0 group-hover:translate-y-4 pointer-events-none">
              ...
              <div className="flex-grow flex flex-col pt-4 opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-500 ease-out pointer-events-none group-hover:pointer-events-auto">
                ...
                <div className="mt-auto flex flex-col gap-2 md:gap-3">
                  ...
                  <BookNowButton 
                    ...
                    className="py-3 bg-white text-gray-900 hover:bg-gray-100 uppercase tracking-wide text-sm font-medium text-center"
                  >
