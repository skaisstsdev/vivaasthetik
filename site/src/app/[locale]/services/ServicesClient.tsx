            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full p-6 md:p-10 text-white">
                ...
                <div className={`absolute inset-0 flex items-center justify-center p-4 md:p-8 transition-all duration-500 pointer-events-none ${isActive ? 'opacity-0 scale-95' : 'opacity-100 scale-100 group-hover:opacity-0 group-hover:scale-95'}`}>
                  <h3 
                    className="text-2xl sm:text-3xl md:text-2xl lg:text-3xl text-center leading-tight text-white/90 break-words hyphens-auto w-full px-2"
          ...
          >
            ...
            <div className="overflow-y-auto flex-1 w-full">
              ...
              <div className="p-8 md:pt-16 md:pb-12 text-center border-b border-gray-200">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-gray-900 leading-tight pr-12 md:pr-0 break-words hyphens-none">
              ...
              <div className="p-8 md:p-16">
                <div 
                  className="prose prose-lg md:prose-xl prose-headings:font-light prose-h3:text-3xl prose-h4:text-2xl prose-headings:break-words prose-headings:hyphens-none break-words max-w-none mx-auto text-gray-800"
